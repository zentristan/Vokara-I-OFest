        ...
        <div class="row justify-content-center row-cols-1">
            <div class="col-8 m-2">
                <div class="form-group">
                    ...
                    <input type="text" class="input-box w-100" placeholder="Nama Proyek">
                </div>
            </div>
            <div class="col-8 m-2">
                <div class="form-group">
                    ...
                    <textarea name="" class="input-box w-100" id="" placeholder="Deskripsi Proyek"></textarea>
                </div>
            </div>
            <div class="col-8 m-2">
                <div class="form-group">
                    ...
                    <input type="number" class="input-box w-100" placeholder="Rp.">
                </div>
            </div>
            <div class="col-8 m-2">
                <div class="form-group">
                    ...
                    <p class="form-deskripsi">Tuliskan range harga yang akan anda tawarkan untuk jasa anda</p>
                    <select name="" id="" class="input-box w-100">
            ...
            <div class="col-8 m-2">
                <div class="form-group">
                    ...
                    <input type="number" class="input-box w-100" placeholder="cth. 10.">
                </div>
            </div>
        </div>
    </div>
